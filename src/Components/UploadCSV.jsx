      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-cyan-500/20 p-8 shadow-2xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            {uploadStatus === 'completed' && (
              <div className="mt-6 p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
                <div className="flex items-center">
                  ...
                  <span className="text-green-400">Upload completed successfully!</span>
                </div>
                <p className="text-sm text-gray-400 mt-1">Data is now being analyzed...</p>
              </div>
            )}
            ...
            >
              {uploadStatus === 'uploading' ? 'Uploading...' : 'Process CSV Data'}
            </button>
          </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gray-900/30 rounded-lg">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-medium text-white">Format Requirements</h4>
                </div>
                <p className="text-gray-400 text-sm">
                  Ensure your CSV file contains the following columns: timestamp, source_ip, destination_ip, event_type, severity
                </p>
              </div>
              ...
              <div className="p-4 bg-gray-900/30 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Files are processed through our immunological analysis engine, which detects patterns and anomalies.
                </p>
              </div>
              ...
              <div className="p-4 bg-gray-900/30 rounded-lg">
                ...
                <p className="text-gray-400 text-sm">
                  Analysis results will appear in your dashboard within minutes, showing threat insights and behavioral patterns.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="bg-gray-900 rounded-lg p-4 overflow-x-auto">
                <code className="text-sm text-gray-300">
                  timestamp,source_ip,destination_ip,event_type,severity<br/>
                  2024-01-15 08:30:15,192.168.1.100,10.0.0.1,connection_established,low<br/>
                  2024-01-15 08:31:22,192.168.1.150,10.0.0.5,data_transfer,medium<br/>
                  2024-01-15 08:32:45,192.168.1.200,10.0.0.8,suspicious_activity,high
                </code>
              </div>
            </div>
          </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="py-3 px-4 text-left text-gray-400 font-medium">File Name</th>
                <th className="py-3 px-4 text-left text-gray-400 font-medium">Uploaded</th>
                <th className="py-3 px-4 text-left text-gray-400 font-medium">Status</th>
                <th className="py-3 px-4 text-left text-gray-400 font-medium">Records</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors">
                <td className="py-3 px-4 text-white">network_traffic_jan15.csv</td>
                <td className="py-3 px-4 text-gray-400">2 hours ago</td>
                <td className="py-3 px-4">
                  <span className="px-2 py-1 text-xs bg-green-500/20 text-green-300 rounded-md">Analyzed</span>
                </td>
              ...
              <tr className="border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors">
                ...
                <td className="py-3 px-4">
                  <span className="px-2 py-1 text-xs bg-blue-500/20 text-blue-300 rounded-md">Processing</span>
                </td>
                <td className="py-3 px-4 text-cyan-400">15,429</td>
              </tr>
              <tr className="hover:bg-gray-800/30 transition-colors">
                <td className="py-3 px-4 text-white">security_events_jan13.csv</td>
