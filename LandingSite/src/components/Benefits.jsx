      ...
      <div className="container relative z-2">
        ...
        <div className="flex flex-wrap gap-10 mb-10">
          {benefits.map((benefit, index) => (
            <div
              className="block relative p-0.5 bg-no-repeat bg-[length:100%_100%] md:max-w-[24rem] transition-all duration-300 hover:scale-105 hover:rotate-y-12 transform-style-3d animate-bounce-in"
              style={{
